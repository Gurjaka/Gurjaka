...
## 🎯 Currently Learning  
- **Advanced C Programming (Memory Management, Data Structures)**
- **Advanced Nix Programming concepts**
- **Shell Scripting & Linux Kernel Internals**
- **Embedded Systems & Low-Level Programming**
- **AI & Machine Learning (Future Plans)**
...
🛠️ *Personalized NixOS configuration files to create an efficient and productive dev environment.*  

🔹 **[Python Roadmap](https://github.com/Gurjaka/Python-Projects-Roadmap)**  
🚀 *A structured learning roadmap that helps users master Python through real-world projects.*  

🔹 **[Gravi Booster](https://github.com/Gurjaka/gravi-booster)**  
🌍 *A simulation tool that models the trajectory of a sphere under gravity & air drag.*  

🔹 **[C-Programming-Language](https://github.com/Gurjaka/C-Programming-Language)**  
📜 *Personal repository for learning and experimenting with C through practice programs.*  
